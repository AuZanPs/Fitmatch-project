    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-mejiwoo-cream to-white flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="font-montserrat text-sm sm:text-base text-mejiwoo-gray">Loading...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 mx-2 sm:mx-0">
            ...
            <div className="bg-gray-50 rounded-lg p-4 sm:p-6 text-left mb-6 sm:mb-8">
              ...
              <ol className="font-montserrat text-xs sm:text-sm text-mejiwoo-gray space-y-2 sm:space-y-3">
                <li>1. Create a Supabase project at <a href="https://supabase.com" target="_blank" rel="noopener noreferrer" className="text-black underline break-all">supabase.com</a></li>
                <li>2. Copy your project URL and anon key from Settings → API</li>
                <li>3. Update the environment variables in your <code className="bg-white px-1.5 py-0.5 rounded text-xs">.env</code> file:</li>
              </ol>
              ...
              <div className="bg-black text-white p-3 sm:p-4 rounded mt-3 sm:mt-4 font-mono text-xs sm:text-sm overflow-x-auto">
                ...
                <div className="whitespace-nowrap">VITE_SUPABASE_ANON_KEY=your-anon-key-here</div>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-mejiwoo-cream to-white flex items-center justify-center px-3 sm:px-4 py-6 sm:py-8 lg:py-0">
      <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 mx-2 sm:mx-0">
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
              <div className="flex items-start gap-3 sm:gap-4 text-left">
                <span className="w-6 h-6 sm:w-8 sm:h-8 bg-black text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0 mt-1 sm:mt-0.5 lg:mt-0">1</span>
                <div className="min-w-0">
                  <h3 className="font-playfair text-base sm:text-lg lg:text-xl font-bold text-black mb-1">Upload Photos</h3>
                  <p className="font-montserrat text-xs sm:text-sm text-gray-600">Add your clothing items with photos</p>
                </div>
              </div>
              
              <div className="flex items-start gap-3 sm:gap-4 text-left">
                <span className="w-6 h-6 sm:w-8 sm:h-8 bg-black text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0 mt-1 sm:mt-0.5 lg:mt-0">2</span>
                <div className="min-w-0">
                  <h3 className="font-playfair text-base sm:text-lg lg:text-xl font-bold text-black mb-1">Tag by Style</h3>
                  <p className="font-montserrat text-xs sm:text-sm text-gray-600">Categorize with style tags</p>
                </div>
              </div>
              
              <div className="flex items-start gap-3 sm:gap-4 text-left">
                <span className="w-6 h-6 sm:w-8 sm:h-8 bg-black text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0 mt-1 sm:mt-0.5 lg:mt-0">3</span>
                <div className="min-w-0">
                  <h3 className="font-playfair text-base sm:text-lg lg:text-xl font-bold text-black mb-1">Browse Outfits</h3>
                  <p className="font-montserrat text-xs sm:text-sm text-gray-600">Find perfect combinations</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 order-1 lg:order-2 mx-2 sm:mx-0">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" className="opacity-50 flex-shrink-0">
